...
_TODO: the opening move. What does this persona read first, and in what order, to get the whole
document in view? What does it do about sections still holding `{emptysec}`?_
